...
TEST_P(EcdhPsi2PartyTest, Works) {
  ...
  auto link_ab = link::test::SetupWorld("ab", 2);

  std::vector<std::shared_ptr<link::Context>> link_ab2(2);
...
TEST_P(EcdhPsi3PartyTest, Works) {
  ...
  auto link_ab = link::test::SetupWorld("ab", 2);
  auto link_abc = link::test::SetupWorld("abc", 3);
...
TEST_P(EcdhPsi4PartyTest, Works) {
  ...
  auto link_ab = link::test::SetupWorld("ab", 2);
  auto link_abc = link::test::SetupWorld("abc", 3);
  auto link_abcd = link::test::SetupWorld("abcd", 4);
