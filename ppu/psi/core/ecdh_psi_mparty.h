...
class EcdhPsiMParty {
 public:
   ...
   */
  void RunMaskSelfAndSend(const std::shared_ptr<link::Context>& link,
                          size_t send_rank);
   ...
   */
  void RunMaskRecvAndForward(const std::shared_ptr<link::Context>& link,
   ...
   *   final compare use kFinalCompareBytes
   */
  void RunMaskRecvAndStore(const std::shared_ptr<link::Context>& link,
   ...
   */
  void RunSendBatch(const std::shared_ptr<link::Context>& link,
                    size_t send_rank,
   ...
   *   final compare use kFinalCompareBytes
   */
  void RunRecvAndStore(const std::shared_ptr<link::Context>& link,
                       size_t recv_rank, size_t dual_mask_size = kHashSize);
