...
class GcmCrypto {
 public:
  GcmCrypto(GcmCryptoSchema schema, utils::ByteContainerView key,
  ...
  void Encrypt(utils::ByteContainerView plaintext, utils::ByteContainerView aad,
               absl::Span<uint8_t> ciphertext, absl::Span<uint8_t> mac) const;

  // Decrypts `ciphertext` into `plaintext`.
  void Decrypt(utils::ByteContainerView ciphertext,
               utils::ByteContainerView aad, utils::ByteContainerView mac,
...
class Aes128GcmCrypto : public GcmCrypto {
 public:
  Aes128GcmCrypto(utils::ByteContainerView key, utils::ByteContainerView iv)
      : GcmCrypto(GcmCryptoSchema::AES128_GCM, key, iv) {}
};

class Aes256GcmCrypto : public GcmCrypto {
 public:
  Aes256GcmCrypto(utils::ByteContainerView key, utils::ByteContainerView iv)
