...
func @main(%arg0: tensor<i64>) -> tensor<i64> {
  ...
  //CHECK:   %1 = "pphlo.constant"() {value = dense<false> : tensor<i1>} : () -> tensor<!pphlo.pint>
  //CHECK:   "pphlo.return"(%1) : (tensor<!pphlo.pint>) -> ()
  //CHECK: },  {
  //CHECK: ^bb0(%arg1: tensor<!pphlo.pint>):  // no predecessors
  //CHECK:   %1 = "pphlo.add"(%arg1, %arg1) {name = "compare.0"} : (tensor<!pphlo.pint>, tensor<!pphlo.pint>) -> tensor<!pphlo.pint>
  //CHECK:   "pphlo.return"(%1) : (tensor<!pphlo.pint>) -> ()
  //CHECK: }) : (tensor<!pphlo.pint>) -> tensor<!pphlo.pint>
  %0 = "mhlo.while"(%arg0) ( {
  ^bb0(%arg1: tensor<i64>):
