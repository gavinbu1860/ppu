...
TEST(ArrayElementwiseTest, NotPredR1) {
  xt::xarray<uint8_t> a = {false, true, true, false};

  auto ret = test::EvalUnaryOp<uint8_t>(VIS_PUBLIC, logical_not, a);

  xt::xarray<uint8_t> expected = {true, false, false, true};
...
TEST(ArrayElementwiseTest, NotS32R1) {
  ...
  auto ret = test::EvalUnaryOp<int32_t>(VIS_PUBLIC, logical_not, a);

  xt::xarray<int32_t> expected = {0, -1, -2};

  // FIXME: Need a bitwise not instead of logical_not
  // EXPECT_EQ(expected, ret);
}
...
TEST(ArrayElementwiseTest, NotU32R1) {
  ...
  auto ret = test::EvalUnaryOp<uint32_t>(VIS_PUBLIC, logical_not, a);
...
TEST(ArrayElementwiseTest, ShiftLeftS32) {
  std::vector<int32_t> a = {static_cast<int32_t>(0x12345678),
                            static_cast<int32_t>(0xF0001000),
                            1,
                            3,
                            77,
                            1,
                            -3,
                            77};
  std::vector<int32_t> b = {4, 8, 2, 7, 15, 32, 100, -1};
  ...
  // auto ret = test::EvalBinaryOp<int32_t>(VIS_PUBLIC, VIS_PUBLIC, left_sift,
  // PtBufferView lhs, PtBufferView rhs)
...
TEST(ArrayElementwiseTest, ShiftRightLogicalS32) {
  xt::xarray<int32_t> a = {static_cast<int32_t>(0x92345678),
                           static_cast<int32_t>(0x10001000),
                           1,
                           3,
                           77,
                           1,
                           -3,
                           77};
  xt::xarray<int32_t> b = {4, 8, 2, 7, 5, 32, 100, -1};
...
TEST(ArrayElementwiseTest, ShiftLeftU32) {
  xt::xarray<uint32_t> a = {0x12345678, 0xF0001000, 1, 3, 77, 1, ~3u, 77};
  xt::xarray<uint32_t> b = {4, 8, 2, 7, 15, 32, 100, ~0u};
...
TEST(ArrayElementwiseTest, ShiftRightLogicalU32) {
  xt::xarray<uint32_t> a = {0x92345678, 0x10001000, 1, 3, 77, 1, ~3u, 77};
  xt::xarray<uint32_t> b = {4, 8, 2, 7, 5, 32, 100, ~0u};
