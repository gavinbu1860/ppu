...
struct is_ro_byte_container_type {
 private:
  ...
  using size_type = decltype(CheckSize<ByteContainerT>(
      static_cast<const ByteContainerT *>(0)));
  ...
  using api_type = decltype(CheckApi<ByteContainerT>(
      static_cast<const ByteContainerT *>(0)));
