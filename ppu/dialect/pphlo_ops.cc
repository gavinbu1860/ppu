...
#include "ppu/dialect/pphlo_ops.h.inc"
#include "ppu/dialect/pphlo_struct_attrs.cc.inc"
...
Type convertPtTypeToPPhloType(Type ptType) {
  if (ptType.isa<FloatType>()) {
    return pphlo::PFixedpointType::get(ptType.getContext());
  }
  return pphlo::PIntegerType::get(ptType.getContext());
}
